...
4.  **Configure Environment Variables**
    ...
    cp .env.example .env
    ```
    Now, edit the `.env` file and add your EUMDAC API credentials: [Guide on how to obtain them](https://user.eumetsat.int/resources/user-guides/eumetsat-data-access-client-eumdac-guide).
    ```ini
